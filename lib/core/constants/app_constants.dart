class AppConstants {
  ...
  // Fal.ai Config
  // Logic moved to Backend Edge Function (generate-video)
  static const String falKey = 'MOVED_TO_BACKEND';
  static const String falEndpoint = 'fal-ai/kling-video/v2.5-turbo/pro/image-to-video';
